          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-red-50 rounded-xl p-8 border border-red-100 shadow-lg">
                ...
                <div className="bg-gray-50 rounded-xl p-8 border border-gray-100 shadow-lg">
                  ...
                  <p className="text-gray-700 text-lg">
                    <a href="mailto:j.smith@university.edu" className="text-red-600 hover:underline font-semibold">
